...
pub fn program() -> morpholog_core::Program {
    morpholog_core::Program {
        ...
        intents: vec![
            intent_decl("TrialOpened").subject("trial_id").build(),
            intent_decl("ProtocolVersionApproved")
                .subject("trial_id")
                .subject("protocol_version")
                .build(),
            intent_decl("ConsentFormVersionApproved")
                .subject("trial_id")
                .subject("consent_form_version")
                .build(),
            intent_decl("InvestigatorDelegated")
                .subject("investigator")
                .subject("trial_id")
                .subject("role")
                .build(),
            intent_decl("ParticipantScreened")
                .subject("participant_id")
                .subject("trial_id")
                .build(),
            intent_decl("InformedConsentObtained")
                .subject("participant_id")
                .subject("consent_form_version")
                .build(),
            intent_decl("EligibilityCriterionRecorded")
                .subject("protocol_version")
                .subject("criterion_id")
                .build(),
            intent_decl("EligibilityAssessmentRecorded")
                .subject("participant_id")
                .subject("criterion_id")
                .build(),
            intent_decl("ImportantProtocolDeviationOpened")
                .subject("participant_id")
                .subject("trial_id")
                .subject("deviation_id")
                .build(),
            intent_decl("ParticipantRandomised")
                .subject("participant_id")
                .build(),
        ],
