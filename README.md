...
- [**Approval limits**](examples/07_approval_limits/) - quantitative authority on top of Example 6: an actor may approve documents *up to a limit*. Forces the IR's first decimal-comparison primitive (`Expr::Le`). A clerk's £1,000 ceiling cannot admit a £4,300 invoice; a director's £100,000 ceiling can.
