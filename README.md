...
- Worked examples: [`examples/01_settlement_netting/`](examples/01_settlement_netting/), [`examples/02_revenue_restatement/`](examples/02_revenue_restatement/), [`examples/03_claim_standing/`](examples/03_claim_standing/), [`examples/04_double_entry_ledger/`](examples/04_double_entry_ledger/), [`examples/05_trial_balance/`](examples/05_trial_balance/), [`examples/06_approval_controls/`](examples/06_approval_controls/).
